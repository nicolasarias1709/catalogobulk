  ...
  <q-layout view="lHh Lpr lFf">
    ...
    >
      <q-list>
        ...
        <q-item clickable to="/proveedores" active-class="text-primary" v-if="usuario">
          <q-item-section avatar><q-icon name="local_shipping" /></q-item-section>
          <q-item-section>Proveedores</q-item-section>
        </q-item>
        <q-item clickable to="/importaciones" active-class="text-primary" v-if="usuario">
          <q-item-section avatar><q-icon name="upload_file" /></q-item-section>
          <q-item-section>Importaciones</q-item-section>
        </q-item>
        <q-item clickable to="/exportaciones" active-class="text-primary" v-if="usuario">

...
async function listar(req, res, next) {
  try {
    const { page, limit, categoria, proveedor, disponible, incluirInactivos } = req.query;
...
async function obtener(req, res, next) {
  try {
    const producto = await productoService.obtenerProducto(req.params.id, req.usuario);

...
async function conectarMongo(intento = 1) {
  try {
    await mongoose.connect(env.MONGO_URI, {
      // Con Atlas, un typo en la URI, una IP no autorizada en "Network
      // Access" o un problema de DNS (mongodb+srv://) se traduce en una
      // conexión que nunca resuelve. Sin este límite, mongoose usa 30s por
      // default; 10s alcanza de sobra y hace que los reintentos de abajo
      // avisen del problema más rápido en vez de colgar la app en frío.
